...
<head>
    ...
    <title>Bespoke Suits for Dogs in jtech playground in jtech playground! (A sample app for CodeDeploy)</title>
...
<body role="document">
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Bespoke Suits for Dogs in jtech playground in jtech playground in jtech playground</a>
      </div>
  ...
  <div class="container theme-showcase" role="main">
    ...
    <% } %>
    <div class="jumbotron">
      <h1>Bespoke Suits for Dogs in jtech playground in jtech playground in jtech playground</h1>
